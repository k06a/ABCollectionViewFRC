#
#  Be sure to run `pod spec lint ABCollectionViewFRC.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/k06a/ABCollectionViewFRC"
  ...
  # Or just: s.author    = "Anton Bukov"
  # s.authors            = { "Anton Bukov" => "k06aaa@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Anton Bukov"
